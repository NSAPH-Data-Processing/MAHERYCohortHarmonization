...
fusen::fill_description(
  ...
  fields = list(
    ...
    Description = "This package establishes a pipeline that harmonizes the MAHERY data across disparate sources and produces a dataset that defines the MAHERY Cohort.",
    `Authors@R` = c(
